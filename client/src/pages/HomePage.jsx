...
const HomePage = ({ userName = "Traveler" }) => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      {/* NavBar removed from here because it is already in App.jsx */}
          ...
          <section>
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="hidden md:flex gap-2">
                <button onClick={() => scroll(trailScrollRef, 'left')} className="p-1.5 rounded-full bg-card border border-border hover:bg-muted transition-all shadow-sm">
                  <ChevronLeft className="w-4 h-4 text-foreground" />
                </button>
                <button onClick={() => scroll(trailScrollRef, 'right')} className="p-1.5 rounded-full bg-card border border-border hover:bg-muted transition-all shadow-sm">
